...
<?php echo app('translator')->get(
    "Если у вас возникли проблемы с нажатием кнопки \":actionText\" скопируйте и вставьте приведенный\n".
    'ниже URL-адрес в веб-браузер:',
    [
...
<?php endif; ?>
<?php echo $__env->renderComponent(); ?>
<?php /**PATH D:\Server\data\htdocs\app.loc\resources\views/vendor/notifications/email.blade.php ENDPATH**/ ?>